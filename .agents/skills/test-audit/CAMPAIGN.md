...
batch: a package, an app, or one core area. The value bar, retention bar,
...
Record maintainer decisions for generic compatibility flags in the commit
message rather than editing gates.
